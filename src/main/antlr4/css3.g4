...
stylesheet
    : ws ( charset ( Comment | Space | Cdo | Cdc )* )* ( imports ( Comment | Space | Cdo | Cdc )* )* ( namespace ( Comment | Space | Cdo | Cdc )* )* ( ( external | containerScope )* nestedStatement ( Comment | Space | Cdo | Cdc )* )*
    ;
